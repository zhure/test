...
export default {
  ...
  methods: {
    ...
    chat(vet) {
      this.chatUser = vet.nickName
      let html = "<div class=\"el-row\" style=\"padding: 5px 0\">\n" +
          "  <div class=\"el-col el-col-2\" style=\"text-align: right\">\n" +
          "  <span class=\"el-avatar el-avatar--circle\" style=\"height: 40px; width: 40px; line-height: 40px;\">\n" +
          "    <img src=\" "+ vet.headImg + "\" style=\"object-fit: cover;\">\n" +
          "  </span>\n" +
          "  </div>\n" +
          "  <div class=\"el-col el-col-22\" style=\"text-align: left; padding-left: 10px\">\n" +
          "    <div >\n" +
          "      <span style=\"display: block\">名称：" + vet.nickName + "</span>\n" +
          "      <span style=\"display: block\">描述：" + vet.vetDescribe + "</span style=\"display: block\">\n" + "</div>\n" +
          "  </div>\n" +
          "</div>";
      this.content = html
    },
    ...
    init() {
      ...
      if (typeof (WebSocket) == "undefined") {
        ...
        console.log("您的浏览器支持WebSocket");
        let socketUrl = "ws://120.79.190.143:9090/imserver/" + username;
        if (socket != null) {
          socket.close();
          socket = null;
        }
